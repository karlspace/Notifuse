...
// UpdateBroadcastStatusTx mocks base method.
func (m *MockBroadcastRepository) UpdateBroadcastStatusTx(arg0 context.Context, arg1 *sql.Tx, arg2 *domain.Broadcast) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateBroadcastStatusTx", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateBroadcastStatusTx indicates an expected call of UpdateBroadcastStatusTx.
func (mr *MockBroadcastRepositoryMockRecorder) UpdateBroadcastStatusTx(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateBroadcastStatusTx", reflect.TypeOf((*MockBroadcastRepository)(nil).UpdateBroadcastStatusTx), arg0, arg1, arg2)
}
